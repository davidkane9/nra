...
Is the difference between the rate of gunshot injuries during NRA conventions different from the rate in the three weeks before and after the convention? I *think* this depends on how we ask the question. We have `r sum(x$convention)` observations for convention weeks and 
